            ...
            <div className="w-full max-w-sm flex-1 flex flex-col justify-center gap-4 my-4">
                ...
                {currentOptions.map((option, idx) => (
                    <button 
                        ...
                        className="group relative w-full p-6 rounded-2xl border active:scale-[0.98] transition-all duration-200 text-left overflow-hidden backdrop-blur-md premium-border"
                        style={{ 
